...
<head>
   ...
   <meta name="description" content="Luckysound - Thanh toán đơn hàng" />
   <title>Luckysound.vn - Thanh toán đơn hàng</title>
                           ...
                           <table class="total-line-table">
                              ...
                              <tfoot class="total-line-table__footer">
                                 <tr class="total-line payment-due">
                                    ...
                                    <td class="total-line__price">
                                       <span class="payment-due__price">{{number_format($totalPrice,0,'','.')}}₫</span>
                                    </td>
                                 </tr>
                              </tfoot>
                           </table>
