        ...
        <div class="col-md-8 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Icon gợi ý</label>
                <image-upload v-model="objData.image" type="avatar" :title="'mua-hang'"></image-upload>
              </div>
            </div>
    ...
    addPromotions(){
      ...
      if (this.errors.length > 0) {
        ...
        this.addPromotion(this.objData).then(response => {
          ...
          this.$success('Thêm gợi ý trang chủ thành công');
        }).catch(error => {
          this.loadings(false);
          this.$error('Thêm gợi ý trang chủ thất bại');
        })
      }
    },
  },
